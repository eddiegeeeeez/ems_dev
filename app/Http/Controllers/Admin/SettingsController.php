...
class SettingsController extends Controller
{
    private function sampleTemplateData(): array
    {
        return [
            ...
            'userName' => 'John Smith',
            'maintenanceDate' => now()->addWeek()->format('F j, Y'),
            'maintenanceTime' => '2:00 PM - 4:00 PM',
            'reason' => 'Routine equipment maintenance',
        ];
    }
...
Events Management Team'),
                ...
                'maintenance_alert' => [
                    'subject' => Cache::get('email_template_maintenance_alert_subject', 'Maintenance Alert: {{venueName}}'),
                    'preheader' => Cache::get('email_template_maintenance_alert_preheader', 'Important maintenance notice for {{venueName}}'),
                    'body' => Cache::get('email_template_maintenance_alert_body', 'Dear {{userName}},

Please be informed that {{venueName}} will undergo maintenance.
...
During this period, the venue will be unavailable for bookings. Please plan accordingly.

For more information, contact the Facilities Management team.

Best regards,
University of Mindanao
Facilities Management'),
                    'footer' => Cache::get('email_template_maintenance_alert_footer', 'This is an automated message from the UM Events Management System. Please do not reply to this email.'),
                ],
            ];
