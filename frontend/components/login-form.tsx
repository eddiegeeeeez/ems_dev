...
export function LoginForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      console.log('[LoginForm] Login completed, user:', loggedInUser)

      const targetUrl = loggedInUser?.role === 'ADMIN' ? '/admin/dashboard' : '/dashboard'
      console.log('[LoginForm] Redirecting to:', targetUrl, 'with role:', loggedInUser?.role)
